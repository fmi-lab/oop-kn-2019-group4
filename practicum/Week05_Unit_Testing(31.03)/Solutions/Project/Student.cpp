...
void Student::copy(char const * _firstName, char const * _lastName, int _fn, int _scoresSize, int const * _scores) {
...
Student::Student(char const * _firstName, char const * _lastName, int _fn, int _scoresSize, int const * _scores) {
